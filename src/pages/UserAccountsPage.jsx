    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all duration-200 shadow-md hover:shadow-lg"
        >
          <Archive size={18} />
      ...
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-4 shadow-lg shadow-blue-100 border border-blue-100">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 bg-blue-50/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 border border-blue-100 transition-all duration-200"
          />
        </div>
      </div>

      {/* Table */}
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg shadow-blue-100 overflow-hidden border border-blue-100">
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-blue-50 to-sky-50 border-b border-blue-200">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-800">Joined Date</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-800">Last Active</th>
              </tr>
            </thead>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-blue-100 bg-gradient-to-r from-blue-50/50 to-sky-50/50">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-lg hover:bg-blue-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              <ChevronLeft size={20} />
            </button>
